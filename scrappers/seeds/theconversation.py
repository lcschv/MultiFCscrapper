...
class TheConversation(Commons):
    ...
    def parse_claim_url(self):
        ...
        for claim_id, claim_url in self.dict_claims_urls.items():
            ...
            try:
                ...
                with open("raw_content/theconversation/" + str(claim_id) + ".html", "w") as f:
                    f.write(str(html))
            except:
                self.reopen_driver()
                continue
    ...
    def get_list_claims_url(self, soup, url):
        ...
        for tag in div_tag:
            ...
            if url_claim not in self.dict_unique_urls:
                ...
                print(url_claim, tag.find("h2").find("a").text.strip())
            ...
            self.claim_num += 1
        print (len(self.dict_article_title),len(self.dict_claims_urls))
    ...
    def start(self):
        ...
        'https://theconversation.com/uk/topics/fact-check-uk-15076?page%2F=4&page=4']
        ...
        self.print_object_as_tsv("schemas/theconversation.txt", self.dict_objects)
        self.summarize_statistics("statistics/theconversation.txt", self.dict_objects)
